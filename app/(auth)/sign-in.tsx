...
export default function SignInScreen() {
  ...
  const { session, initializing, signInWithEmail, signInWithApple, signInWithGoogle, error, isDeveloper } = useAuth();
    ...
    <SafeAreaView style={styles.safeArea}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.container}>
        <View style={styles.card}>
          ...
          <ThemedText style={styles.subtitle}>Sign in to keep your picks and streaks synced.</ThemedText>
          ...
          <TouchableOpacity style={[styles.button, styles.primaryButton]} onPress={handleEmailSignIn} disabled={loading}>
          ...
          {isDeveloper ? (
            <ThemedText style={styles.devNote}>Developer mode: full access unlocked.</ThemedText>
          ) : null}
        </View>
